  ...
  "MSFT": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Strong",
        "timeframes": [
          { "tf": "Daily", "bias": "bullish", "note": "ประคองตัวยืนเหนือเส้น EMA 20 และ 50 วันได้อย่างมั่นคง" },
          { "tf": "Weekly", "bias": "bullish", "note": "แนวโน้มหลักเป็นขาขึ้นชัดเจนในกรอบคู่ขนานระยะยาว" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 420.55 },
        "poc": { "label": "POC", "price": 415.00 },
        "resistances": [{ "label": "R1", "price": 435.00 }, { "label": "R2", "price": 450.00 }],
        "supports": [{ "label": "S1", "price": 410.00 }, { "label": "S2", "price": 395.00 }],
        "vah": { "label": "VAH", "price": 428.00 },
        "val": { "label": "VAL", "price": 402.00 }
      },
      "entry": {
        "signal": "BUY",
        "entryZone": "$410 - $418",
    ...
    "fundamental": {
      "overallGrade": "A+",
      "gradeBreakdown": [
        { "label": "Growth Quality", "score": 98, "color": "var(--accent-primary)" },
        { "label": "Capital Efficiency", "score": 96, "color": "#10b981" },
        { "label": "Balance Sheet Safety", "score": 100, "color": "#6366f1" }
      ],
      "ratios": {
    ...
    "thesis": {
      ...
      "sources": ["Microsoft Q3 FY2026 Earnings", "Cloud Infrastructure Market Outlook"]
    }
  },
  "AAPL": {
    "meta": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Medium",
        "timeframes": [
          { "tf": "Daily", "bias": "bearish", "note": "ราคาย่อตัวปรับฐานลงมาทดสอบแนวรับเส้นค่าเฉลี่ย EMA 200 วัน" },
          { "tf": "Weekly", "bias": "bullish", "note": "เทรนด์ใหญ่ระยะยาวรักษาระดับฐานรากที่แข็งแกร่งอย่างมั่นคง" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 189.50 },
        "poc": { "label": "POC", "price": 182.00 },
        "resistances": [{ "label": "R1", "price": 198.00 }, { "label": "R2", "price": 208.00 }],
        "supports": [{ "label": "S1", "price": 184.00 }, { "label": "S2", "price": 175.00 }],
        "vah": { "label": "VAH", "price": 195.00 },
        "val": { "label": "VAL", "price": 178.00 }
      },
      "entry": {
        "signal": "BUY",
        "entryZone": "$182 - $188",
    ...
    "fundamental": {
      "overallGrade": "A",
      "gradeBreakdown": [
        { "label": "Growth Quality", "score": 88, "color": "var(--accent-primary)" },
        { "label": "Capital Efficiency", "score": 100, "color": "#10b981" },
        { "label": "Balance Sheet Safety", "score": 92, "color": "#6366f1" }
      ],
      "ratios": {
    ...
    "thesis": {
      ...
      "sources": ["Apple Q2 2026 Operational Results", "Global Premium Smartphone Market Analysis"]
    }
  },
  "AMZN": {
    "meta": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Strong",
        "timeframes": [
          { "tf": "Daily", "bias": "bullish", "note": "ราคาสามารถยืนสร้างฐานเหนียวแน่นเหนือกรอบสะสมเดิมช่วง $175 ได้สำเร็จ" },
          { "tf": "Weekly", "bias": "bullish", "note": "แนวโน้มขาขึ้นได้รับการสนับสนุนด้วยโวลุ่มซื้อขายที่เพิ่มขึ้นอย่างมั่นคง" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 182.20 },
        "poc": { "label": "POC", "price": 172.00 },
        "resistances": [{ "label": "R1", "price": 192.00 }, { "label": "R2", "price": 205.00 }],
        "supports": [{ "label": "S1", "price": 175.00 }, { "label": "S2", "price": 164.00 }],
        "vah": { "label": "VAH", "price": 186.00 },
        "val": { "label": "VAL", "price": 162.00 }
      },
      "entry": {
        "signal": "BUY",
        "entryZone": "$172 - $178",
    ...
    "fundamental": {
      "overallGrade": "A",
      "gradeBreakdown": [
        { "label": "Growth Quality", "score": 94, "color": "var(--accent-primary)" },
        { "label": "Capital Efficiency", "score": 86, "color": "#10b981" },
        { "label": "Balance Sheet Safety", "score": 90, "color": "#6366f1" }
      ],
      "ratios": {
    ...
    "thesis": {
      ...
      "sources": ["Amazon Q1 2026 Earnings Release", "E-commerce Logistics Infrastructure Review"]
    }
  },
  "META": {
    "meta": {
    ...
    "technical": {
      ...
      "levels": {
        "current": { "label": "Current", "price": 611.65 },
        "poc": { "label": "POC", "price": 575.00 },
        "resistances": [{ "label": "R1", "price": 615.00 }, { "label": "R2", "price": 630.00 }],
        "supports": [{ "label": "S1", "price": 560.00 }, { "label": "S2", "price": 530.00 }],
        "vah": { "label": "VAH", "price": 592.00 },
        "val": { "label": "VAL", "price": 545.00 }
      },
      "entry": {
        "signal": "BUY",
        "entryZone": "$560 - $575",
    ...
    "fundamental": {
      "overallGrade": "A",
      "gradeBreakdown": [
        { "label": "Growth Quality", "score": 95, "color": "var(--accent-primary)" },
        { "label": "Capital Efficiency", "score": 90, "color": "#10b981" },
        { "label": "Balance Sheet Safety", "score": 95, "color": "#6366f1" }
      ],
      "ratios": {
    ...
    "thesis": {
      ...
      "sources": ["Meta Q1 2026 Earnings Report", "Global Advertising Spend Trends 2026"]
    }
  },
  "TSLA": {
    "meta": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Medium",
        "timeframes": [
          { "tf": "Daily", "bias": "bullish", "note": "ราคาทะลุผ่านแนวต้านเส้นเทรนด์ไลน์ขาลงระยะสั้น พร้อมโวลุ่มสนับสนุน" },
          { "tf": "Weekly", "bias": "neutral", "note": "ราคากำลังพยายามสะสมกำลังเพื่อทวงคืนเส้นค่าเฉลี่ย EMA 50 สัปดาห์" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 178.50 },
        "poc": { "label": "POC", "price": 168.00 },
        "resistances": [{ "label": "R1", "price": 192.00 }, { "label": "R2", "price": 208.00 }],
        "supports": [{ "label": "S1", "price": 165.00 }, { "label": "S2", "price": 152.00 }],
        "vah": { "label": "VAH", "price": 184.00 },
        "val": { "label": "VAL", "price": 158.00 }
      },
      "entry": {
        "signal": "BUY",
        "entryZone": "$166 - $174",
    ...
    "fundamental": {
      "overallGrade": "B",
      "gradeBreakdown": [
        { "label": "Growth Quality", "score": 82, "color": "var(--accent-primary)" },
        { "label": "Capital Efficiency", "score": 78, "color": "#10b981" },
        { "label": "Balance Sheet Safety", "score": 96, "color": "#6366f1" }
      ],
      "ratios": {
        "operatingMargin": "9.2%",
        "roe": "14.8%",
    ...
    "thesis": {
      ...
      "sources": ["Tesla Q1 2026 Operational Results", "Autonomous Vehicles Global Legal Frameworks"]
    }
  },
  "ASML": {
    "meta": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Strong",
        "timeframes": [
          { "tf": "Daily", "bias": "bullish", "note": "ราคารีบาวด์ขึ้นอย่างแข็งแกร่งจากแนวรับจิตวิทยาจิตวิทยา $1,350 พร้อมโวลุ่มหนุนหนาแน่น" },
          { "tf": "Weekly", "bias": "bullish", "note": "ประคองตัวยืนเหนือแนวรับเส้นค่าเฉลี่ยสัปดาห์ได้อย่างแข็งแกร่งเป็นประวัติการณ์" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 1376.40 },
        "poc": { "label": "POC", "price": 1320.00 },
        "resistances": [{ "label": "R1", "price": 1420.00 }, { "label": "R2", "price": 1480.00 }],
        "supports": [{ "label": "S1", "price": 1320.00 }, { "label": "S2", "price": 1280.00 }],
        "vah": { "label": "VAH", "price": 1395.00 },
        "val": { "label": "VAL", "price": 1285.00 }
      },
      "entry": {
        "signal": "BUY",
        "entryZone": "$1310 - $1345",
    ...
    "thesis": {
      ...
      "sources": ["ASML Q1 2026 Operational Results", "EUV Lithography Supply Chain Monopoly Review"]
    }
  }
}
...
const screenerData = {screener_data_json};
...
def generate_js_content(title, stocks_list, active_stock, stocks_data_dict, selector_options, screener_data):
    ...
    screener_data_json = json.dumps(screener_data, indent=2, ensure_ascii=False)
    content = js_template.format(
        ...
        screener_data_json=screener_data_json
    )
    return content
...
watchlist_metadata = {
    ...
    "GOOGL": {"name": "Alphabet", "sector": "Technology", "pe": 24.5},
    "META": {"name": "Meta Platforms", "sector": "Technology", "pe": 24.5},
    "TSLA": {"name": "Tesla", "sector": "Consumer Cyclical", "pe": 58.5},
    ...
    "AVGO": {"name": "Broadcom", "sector": "Technology", "pe": 35.2},
    "NFLX": {"name": "Netflix", "sector": "Communication", "pe": 36.4},
    "COIN": {"name": "Coinbase", "sector": "Financials", "pe": 28.5},
    "CRWD": {"name": "CrowdStrike", "sector": "Technology", "pe": 72.0},
    "SMCI": {"name": "Super Micro", "sector": "Technology", "pe": 18.5},
    "CELH": {"name": "Celsius", "sector": "Consumer Defensive", "pe": 45.0},
    "VRT": {"name": "Vertiv", "sector": "Industrials", "pe": 38.5},
    "NU": {"name": "Nu Holdings", "sector": "Financials", "pe": 28.4},
    "MELI": {"name": "MercadoLibre", "sector": "Consumer Cyclical", "pe": 46.5},
    "MSTR": {"name": "MicroStrategy", "sector": "Technology", "pe": 95.0},
    "HOOD": {"name": "Robinhood", "sector": "Financials", "pe": 24.2},
    "LUNR": {"name": "Intuitive Machines", "sector": "Industrials", "pe": 15.0},
    "QCOM": {"name": "Qualcomm", "sector": "Technology", "pe": 18.2},
    "ARM": {"name": "ARM Holdings", "sector": "Technology", "pe": 75.0},
    "PANW": {"name": "Palo Alto", "sector": "Technology", "pe": 48.0},
    "NET": {"name": "Cloudflare", "sector": "Technology", "pe": 68.0},
    "DDOG": {"name": "Datadog", "sector": "Technology", "pe": 54.0},
    "SNOW": {"name": "Snowflake", "sector": "Technology", "pe": 62.0},
    "ABNB": {"name": "Airbnb", "sector": "Consumer Cyclical", "pe": 26.5},
    "UBER": {"name": "Uber", "sector": "Industrials", "pe": 31.4},
    "PATH": {"name": "UiPath", "sector": "Technology", "pe": 22.0},
    "SQ": {"name": "Block Inc.", "sector": "Financials", "pe": 26.8}
}
...
for sym, meta_static in watchlist_metadata.items():
    ...
    try:
        with urllib.request.urlopen(req, timeout=5) as response:
            ...
            # Volume spike relative to last 20 days
            avg_volume = sum(volumes[-20:]) / len(volumes[-20:]) if len(volumes) >= 20 else (sum(volumes)/len(volumes) if volumes else 1)
            today_volume = volumes[-1] if volumes else 1
            vol_spike = round(today_volume / avg_volume, 2) if avg_volume > 0 else 1.0
            
            # Compute Multi-Factor Score (out of 10)
            score = 0
            ...
            # 5. RSI 50 to 65 (Momentum sweet spot)
            if 50 <= rsi <= 65: score += 1
            # 6. Volume spike > 1.3x
            if vol_spike > 1.3: score += 1
            # 7. Volume spike > 2.0x
            if vol_spike > 2.0: score += 1
            # 8. PE < 30
            pe_val = meta_static["pe"]
            if pe_val < 30: score += 1
            # 9. PE < 15
            if pe_val < 15: score += 1
...
# Strip any unexpected escaped backticks to prevent JS SyntaxErrors
