...
# Data for My Portfolio: MU, TSM, NVDA, GOOGL
portfolio_data = {
  "GOOGL": {
    "meta": {
      "symbol": "GOOGL",
    ...
    "technical": {
      ...
      "trend": {
        ...
        "timeframes": [
          { "tf": "Daily", "bias": "bullish", "note": "อยู่ในแนวโน้มขาขึ้นในกรอบคู่ขนาน (Trend Channel)" },
          { "tf": "Weekly", "bias": "bullish", "note": "รักษาฐานเหนือเส้นค่าเฉลี่ย EMA 20 ได้อย่างมั่นคง" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 387.66 },
        "poc": { "label": "POC", "price": 375.00 },
        "resistances": [{ "label": "R1", "price": 400.00 }, { "label": "R2", "price": 415.00 }],
        "supports": [{ "label": "S1", "price": 375.00 }, { "label": "S2", "price": 365.00 }],
        "vah": { "label": "VAH", "price": 392.00 },
        "val": { "label": "VAL", "price": 362.00 }
      },
      "entry": {
        "signal": "BUY",
        "entryZone": "$375 – $385",
      ...
      "confluences": [
        { "name": "แนวรับขอบล่างของ Trend Channel", "confirmed": True },
        { "name": "แนวรับปริมาณการซื้อขายหนาแน่น Volume Profile POC ($375)", "confirmed": True },
        { "name": "RSI ระดับ 55 บ่งชี้โมเมนตัมยังมีแรงไปต่อ", "confirmed": True }
      ],
      "risk": {
        "positionSize": "3%",
        "riskPct": "6.5%",
    ...
    "fundamental": {
      "incomeStatement": [
        { "metric": "Revenue Growth", "value": "+22.0%", "grade": "A" },
        { "metric": "Operating Margin", "value": "36.1%", "grade": "A" }
      ],
      "balanceSheet": [
        { "metric": "Debt/Equity", "value": "0.05", "grade": "A" },
        { "metric": "ROE", "value": "30.5%", "grade": "A" }
      ],
      "cashflow": [
        { "metric": "Free Cash Flow", "value": "$69.0B", "grade": "A" }
      ],
      "valuation": [
        { "metric": "P/E Ratio", "value": "24.5x", "grade": "B" },
        { "metric": "PEG Ratio", "value": "0.95", "grade": "A" }
      ],
      "overallGrade": "A",
      "gradeBreakdown": [
        { "label": "Profitability", "score": 92, "color": "var(--grade-a)" },
        { "label": "Growth", "score": 88, "color": "var(--grade-a)" },
        { "label": "Financial Health", "score": 98, "color": "var(--grade-a)" }
      ],
      "moat": {
        "overall": "Wide",
        "items": [
          { "icon": "🧠", "name": "Data Advantage & Search Monopoly", "strength": 95, "description": "การครองส่วนแบ่งตลาดการค้นหาทั่วโลกกว่า 90% และโครงสร้างพื้นฐาน AI (Gemini + TPU)" }
        ]
      }
    },
    "thesis": {
      ...
      "sources": ["Q1 2026 Earnings Report", "SEC filings"]
    }
  },
  "MU": {
    "meta": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Strong",
        "timeframes": [
          { "tf": "Daily", "bias": "bullish", "note": "ทะยานผ่านแรงต้านระยะสั้นขึ้นมาอย่างแข็งแกร่งด้วยปริมาณการซื้อขายหนาแน่น" },
          { "tf": "Weekly", "bias": "bullish", "note": "ฟื้นตัวจากจุดพักฐานใหญ่และกำลังกลับขึ้นไปทดสอบจุดสูงสุดเดิม" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 762.10 },
        "poc": { "label": "POC", "price": 720.00 },
        "resistances": [{ "label": "R1", "price": 803.00 }, { "label": "R2", "price": 830.00 }],
        "supports": [{ "label": "S1", "price": 740.00 }, { "label": "S2", "price": 710.00 }],
        "vah": { "label": "VAH", "price": 770.00 },
        "val": { "label": "VAL", "price": 680.00 }
      },
      "entry": {
        "signal": "BUY",
        "entryZone": "$740 – $755",
      ...
      "confluences": [
        { "name": "ทะลุผ่านต้านจิตวิทยา $740 ได้สำเร็จ", "confirmed": True },
        { "name": "RSI ดีดตัวเหนือ 60 ชี้ถึงแรงซื้อที่เพิ่มขึ้น", "confirmed": True },
        { "name": "สอดคล้องกับงบและเป้าหมายจากสถาบันการเงินที่ปรับเพิ่มขึ้น", "confirmed": True }
      ],
      "risk": {
        "positionSize": "3%",
        "riskPct": "6.8%",
    ...
    "fundamental": {
      "incomeStatement": [
        { "metric": "Revenue Growth", "value": "+57.0%", "grade": "A" },
        { "metric": "Net Income", "value": "$5.48B", "grade": "A" }
      ],
      "balanceSheet": [
        { "metric": "Current Ratio", "value": "2.5", "grade": "A" },
        { "metric": "ROE", "value": "22.5%", "grade": "B" }
      ],
      "cashflow": [
        { "metric": "Free Cash Flow", "value": "$3.9B", "grade": "A" }
      ],
      "valuation": [
        { "metric": "P/E Ratio", "value": "35.0x", "grade": "C" },
        { "metric": "PEG Ratio", "value": "1.2", "grade": "B" }
      ],
      "overallGrade": "A-",
      "gradeBreakdown": [
        { "label": "Growth", "score": 95, "color": "var(--grade-a)" },
        { "label": "Profitability", "score": 78, "color": "var(--grade-b)" },
        { "label": "Valuation", "score": 60, "color": "var(--grade-c)" }
      ],
      "moat": {
        "overall": "Narrow",
        "items": [
          { "icon": "⚙️", "name": "Oligopoly Memory Dominance", "strength": 80, "description": "1 ใน 3 ผู้นำโลกด้านหน่วยความจำ DRAM และ NAND ร่วมกับ Samsung และ SK Hynix" }
        ]
      }
    },
    "thesis": {
      ...
      "sources": ["Q1 2026 Earnings Transcript", "NVIDIA Supplier Reports"]
    }
  },
  "TSM": {
    "meta": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Strong",
        "timeframes": [
          { "tf": "Daily", "bias": "bullish", "note": "ยืนเหนือเส้นค่าเฉลี่ย EMA 50 และ EMA 20 ได้อย่างเด่นชัด" },
          { "tf": "Weekly", "bias": "bullish", "note": "กรอบภาพใหญ่เป็นขาขึ้นแข็งแกร่งต่อเนื่องมาตลอดทั้งปี" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 407.15 },
        "poc": { "label": "POC", "price": 380.00 },
        "resistances": [{ "label": "R1", "price": 421.00 }, { "label": "R2", "price": 440.00 }],
        "supports": [{ "label": "S1", "price": 395.00 }, { "label": "S2", "price": 380.00 }],
        "vah": { "label": "VAH", "price": 410.00 },
        "val": { "label": "VAL", "price": 360.00 }
      },
      "entry": {
        "signal": "BUY",
        "entryZone": "$390 – $405",
      ...
      "confluences": [
        { "name": "แนวรับตามเส้นค่าเฉลี่ย EMA 20 และ EMA 50", "confirmed": True },
        { "name": "ฐานราคาปริมาณการซื้อขายหนาแน่นที่ POC $380", "confirmed": True },
        { "name": "ความแข็งแกร่งสัมพัทธ์ (Relative Strength) ดีกว่าตลาด", "confirmed": True }
      ],
      "risk": {
        "positionSize": "5%",
        "riskPct": "5.0%",
    ...
    "fundamental": {
      "incomeStatement": [
        { "metric": "Revenue Growth", "value": "+35.1%", "grade": "A" },
        { "metric": "Operating Margin", "value": "58.1%", "grade": "A" }
      ],
      "balanceSheet": [
        { "metric": "Debt/Equity", "value": "0.3", "grade": "B" },
        { "metric": "ROE", "value": "32.0%", "grade": "A" }
      ],
      "cashflow": [
        { "metric": "Free Cash Flow", "value": "Strong", "grade": "A" }
      ],
      "valuation": [
        { "metric": "P/E Ratio", "value": "28.0x", "grade": "B" },
        { "metric": "PEG Ratio", "value": "0.8", "grade": "A" }
      ],
      "overallGrade": "A+",
      "gradeBreakdown": [
        { "label": "Profitability", "score": 99, "color": "var(--grade-a)" },
        { "label": "Moat Strength", "score": 98, "color": "var(--grade-a)" },
        { "label": "Financial Health", "score": 90, "color": "var(--grade-a)" }
      ],
      "moat": {
        "overall": "Wide",
        "items": [
          { "icon": "🏭", "name": "Foundry Monopoly", "strength": 99, "description": "การผูกขาดผลิตชิประดับก้าวหน้าของโลก (<3nm) มากกว่า 90% ให้กับเทคยักษ์ใหญ่อย่าง Apple, NVIDIA และ AMD" }
        ]
      }
    },
    "thesis": {
      ...
      "sources": ["Q1 2026 Earnings Call Transcript", "SemiWiki Industry Reports"]
    }
  },
  "NVDA": {
    "meta": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Neutral",
        "timeframes": [
          { "tf": "Daily", "bias": "neutral", "note": "ย่อตัวออกข้างหลังจากพุ่งชนแรงต้านจุดสูงสุดตลอดกาลที่ $236" },
          { "tf": "Weekly", "bias": "bullish", "note": "ยังคงอยู่บนทิศทางขาขึ้นระยะกลางอย่างสมบูรณ์แบบ" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 219.51 },
        "poc": { "label": "POC", "price": 215.00 },
        "resistances": [{ "label": "R1", "price": 236.00 }, { "label": "R2", "price": 250.00 }],
        "supports": [{ "label": "S1", "price": 212.00 }, { "label": "S2", "price": 200.00 }],
        "vah": { "label": "VAH", "price": 230.00 },
        "val": { "label": "VAL", "price": 200.00 }
      },
      "entry": {
      ...
      "confluences": [
        { "name": "แนวรับเส้นค่าเฉลี่ย EMA 50 วันพยุงราคาอยู่", "confirmed": True },
        { "name": "แนวรับโซนที่มีความสำคัญ Volume Profile POC ที่ $215", "confirmed": True },
        { "name": "โมเมนตัมเกิดการคลายความตึงตัว (RSI คูลดาวน์ลงมาแถว 48)", "confirmed": True }
      ],
      "risk": {
        "positionSize": "3%",
        "riskPct": "10.0%",
    ...
    "fundamental": {
      "incomeStatement": [
        { "metric": "Revenue Growth", "value": "+85.0%", "grade": "A" },
        { "metric": "Data Center Rev", "value": "$75.2B", "grade": "A" }
      ],
      "balanceSheet": [
        { "metric": "Debt/Equity", "value": "0.1", "grade": "A" },
        { "metric": "ROE", "value": "85.0%", "grade": "A" }
      ],
      "cashflow": [
        { "metric": "Stock Buyback", "value": "$80B", "grade": "A" }
      ],
      "valuation": [
        { "metric": "P/E Ratio", "value": "45.0x", "grade": "C" },
        { "metric": "PEG Ratio", "value": "1.1", "grade": "B" }
      ],
      "overallGrade": "A+",
      "gradeBreakdown": [
        { "label": "Growth", "score": 99, "color": "var(--grade-a)" },
        { "label": "Profitability", "score": 98, "color": "var(--grade-a)" },
        { "label": "Financial Strength", "score": 95, "color": "var(--grade-a)" }
      ],
      "moat": {
        "overall": "Wide",
        "items": [
          { "icon": "💻", "name": "CUDA Ecosystem & Hardware Domination", "strength": 98, "description": "ความเหนือชั้นของชิป Blackwell บวกกับซอฟต์แวร์ CUDA ที่ผูกขาดและเป็นระบบปิดสำหรับนักพัฒนา AI ทั่วโลก" }
        ]
      }
    },
    "thesis": {
  ...
  "META": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Neutral",
        "timeframes": [
          { "tf": "Daily", "bias": "bearish", "note": "ย่อตัวปรับฐานลงมาต่ำกว่าแนวรับ MA 50 วัน จากแรงกดดันงบ CapEx" },
          { "tf": "Weekly", "bias": "bullish", "note": "เทรนด์ระยะยาวยังคงทรงตัวในระดับสูง แข็งแกร่งสอดคล้องกับงบการเงิน" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 607.38 },
        "poc": { "label": "POC", "price": 610.00 },
        "resistances": [{ "label": "R1", "price": 620.00 }, { "label": "R2", "price": 645.00 }],
        "supports": [{ "label": "S1", "price": 600.00 }, { "label": "S2", "price": 580.00 }],
        "vah": { "label": "VAH", "price": 630.00 },
        "val": { "label": "VAL", "price": 580.00 }
      },
      "entry": {
        "signal": "BUY",
        "entryZone": "$580 – $600",
      ...
      "confluences": [
        { "name": "แนวรับจิตวิทยาจิตวิทยาที่มั่นคงระดับ $600", "confirmed": True },
        { "name": "RSI เริ่มฟื้นตัวจากสภาวะใกล้เขตขายมากเกินไป (Oversold)", "confirmed": True },
        { "name": "การทดสอบแนวรับบริเวณแนวเส้น VAH ต่ำสุดของปี", "confirmed": True }
      ],
      "risk": {
        "positionSize": "5%",
        "riskPct": "6.0%",
    ...
    "fundamental": {
      "incomeStatement": [
        { "metric": "Revenue Growth", "value": "+33.0%", "grade": "A" },
        { "metric": "Adjusted EPS", "value": "$7.31", "grade": "A" }
      ],
      "balanceSheet": [
        { "metric": "Debt/Equity", "value": "0.1", "grade": "A" },
        { "metric": "ROE", "value": "35.0%", "grade": "A" }
      ],
      "cashflow": [
        { "metric": "Free Cash Flow", "value": "Strong", "grade": "A" }
      ],
      "valuation": [
        { "metric": "P/E Ratio", "value": "22.0x", "grade": "A" },
        { "metric": "PEG Ratio", "value": "1.2", "grade": "A" }
      ],
      "overallGrade": "A",
      "gradeBreakdown": [
        { "label": "Growth", "score": 90, "color": "var(--grade-a)" },
        { "label": "Financial strength", "score": 95, "color": "var(--grade-a)" },
        { "label": "Profitability", "score": 92, "color": "var(--grade-a)" }
      ],
      "moat": {
        "overall": "Wide",
        "items": [
          { "icon": "🌐", "name": "Network Effects & Users Advantage", "strength": 95, "description": "การเข้าครอบครองผู้ใช้งานกว่า 3.56 พันล้านคนต่อวัน (Daily Active People) ผ่านแพลตฟอร์ม Facebook, Instagram, WhatsApp" }
        ]
      }
    },
    "thesis": {
      ...
      "sources": ["Q1 2026 Earnings Report", "Meta AI Summit Presentation"]
    }
  },
  "LLY": {
    "meta": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Very Strong",
        "timeframes": [
          { "tf": "Daily", "bias": "bullish", "note": "วิ่งลอยตัวทำจุดสูงสุดใหม่อย่างเด่นชัดเหนือเส้นเฉลี่ยระยะสั้น EMA 20" },
          { "tf": "Weekly", "bias": "bullish", "note": "เทรนด์ใหญ่ขาขึ้นประคองตัวได้อย่างงดงาม ไร้แรงกดดันทางเทคนิค" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 1041.65 },
        "poc": { "label": "POC", "price": 950.00 },
        "resistances": [{ "label": "R1", "price": 1080.00 }, { "label": "R2", "price": 1150.00 }],
        "supports": [{ "label": "S1", "price": 1000.00 }, { "label": "S2", "price": 950.00 }],
        "vah": { "label": "VAH", "price": 1020.00 },
        "val": { "label": "VAL", "price": 900.00 }
      },
      "entry": {
        "signal": "BUY",
        "entryZone": "$980 – $1020",
      ...
      "confluences": [
        { "name": "แนวโน้มโมเมนตัมขาขึ้นที่แข็งแกร่งอย่างยิ่งยวด", "confirmed": True },
        { "name": "การยืนยันการทะลุผ่านระนาบสำคัญ $1,000", "confirmed": True },
        { "name": "แรงหนุนทางพื้นฐานของอุตสาหกรรมยาดูแลน้ำหนักที่ไร้ผู้เทียบทาน", "confirmed": True }
      ],
      "risk": {
        "positionSize": "3%",
        "riskPct": "11.0%",
    ...
    "fundamental": {
      "incomeStatement": [
        { "metric": "Revenue Growth", "value": "+56.0%", "grade": "A" },
        { "metric": "Adjusted EPS", "value": "$8.55", "grade": "A" }
      ],
      "balanceSheet": [
        { "metric": "Debt/Equity", "value": "0.5", "grade": "B" },
        { "metric": "ROE", "value": "45.0%", "grade": "A" }
      ],
      "cashflow": [
        { "metric": "Free Cash Flow", "value": "Growing", "grade": "A" }
      ],
      "valuation": [
        { "metric": "P/E Ratio", "value": "55.0x", "grade": "C" },
        { "metric": "PEG Ratio", "value": "1.6", "grade": "B" }
      ],
      "overallGrade": "A-",
      "gradeBreakdown": [
        { "label": "Growth", "score": 99, "color": "var(--grade-a)" },
        { "label": "Profitability", "score": 95, "color": "var(--grade-a)" },
        { "label": "Valuation", "score": 55, "color": "var(--grade-c)" }
      ],
      "moat": {
        "overall": "Wide",
        "items": [
          { "icon": "💊", "name": "Patents & Monopolistic Efficacy", "strength": 98, "description": "การเป็นเจ้าของสิทธิบัตรยาและประสิทธิภาพสูงสุดของยาลดน้ำหนัก Mounjaro และ Zepbound ที่ถือส่วนแบ่งคู่คี่กับ Novo Nordisk สองรายใหญ่ในตลาดโรคอ้วนโลก" }
        ]
      }
    },
    "thesis": {
      ...
      "sources": ["Eli Lilly Q1 2026 Earnings Presentation", "NEJM Obesity Market Studies"]
    }
  },
  "VRT": {
    "meta": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Strong",
        "timeframes": [
          { "tf": "Daily", "bias": "neutral", "note": "ปรับฐานพักตัวลงมาที่แนวเส้นเฉลี่ย MA 50 วัน หลังจากแตะจุดสูงสุด ATH เดิม" },
          { "tf": "Weekly", "bias": "bullish", "note": "ทิศทางหลักระยะยาวยังคงรักษาแนวโน้มขาขึ้นประคองระดับได้อย่างงดงาม" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 327.70 },
        "poc": { "label": "POC", "price": 300.00 },
        "resistances": [{ "label": "R1", "price": 376.00 }, { "label": "R2", "price": 400.00 }],
        "supports": [{ "label": "S1", "price": 315.00 }, { "label": "S2", "price": 300.00 }],
        "vah": { "label": "VAH", "price": 350.00 },
        "val": { "label": "VAL", "price": 280.00 }
      },
      "entry": {
        "signal": "BUY",
        "entryZone": "$290 – $315",
      ...
      "confluences": [
        { "name": "การประคองตัวอย่างเหนียวแน่นใกล้เส้นค่าเฉลี่ย MA 50 วัน", "confirmed": True },
        { "name": "ความใกล้เคียงกับแนวรับ Volume Profile POC ระดับ $300", "confirmed": True },
        { "name": "แท่งเทียนกลับตัวส่งสัญญาณซื้อที่เด้งรับใกล้บริเวณแนวรับสำคัญ", "confirmed": True }
      ],
      "risk": {
        "positionSize": "4%",
        "riskPct": "10.0%",
    ...
    "fundamental": {
      "incomeStatement": [
        { "metric": "Revenue Growth", "value": "+30.0%", "grade": "A" },
        { "metric": "Operating Margin", "value": "20.8%", "grade": "A" }
      ],
      "balanceSheet": [
        { "metric": "Debt/Equity", "value": "1.2", "grade": "B" },
        { "metric": "ROE", "value": "55.0%", "grade": "A" }
      ],
      "cashflow": [
        { "metric": "Free Cash Flow", "value": "$653M (+147%)", "grade": "A" }
      ],
      "valuation": [
        { "metric": "P/E Ratio", "value": "35.0x", "grade": "B" },
        { "metric": "PEG Ratio", "value": "0.9", "grade": "A" }
      ],
      "overallGrade": "A",
      "gradeBreakdown": [
        { "label": "Growth", "score": 95, "color": "var(--grade-a)" },
        { "label": "Financial health", "score": 82, "color": "var(--grade-b)" },
        { "label": "Profitability", "score": 90, "color": "var(--grade-a)" }
      ],
      "moat": {
        "overall": "Narrow",
        "items": [
          { "icon": "❄️", "name": "Liquid Cooling Tech Dominance", "strength": 85, "description": "การเป็นผู้บุกเบิกและเจ้าของโครงสร้างพื้นฐานระบบระบายความร้อนด้วยน้ำขั้นสูง (Liquid Cooling) ที่สำคัญอย่างยิ่งต่อการออกแบบ AI Data Center ด้วยชิปกำลังความร้อนสูงรุ่น Blackwell" }
        ]
      }
    },
    "thesis": {
      ...
      "sources": ["Vertiv Q1 2026 Financial Results", "Data Center Frontier Research Reports"]
    }
  },
  "NU": {
    "meta": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Weak",
        "timeframes": [
          { "tf": "Daily", "bias": "bearish", "note": "ย่อตัวปรับฐานลงมาหลังจากงบการเงิน แต่อยู่ระหว่างฟื้นตัวกลับหลังจากการทดสอบแนวรับจิตวิทยาจิตวิทยาสำคัญ" },
          { "tf": "Weekly", "bias": "bullish", "note": "เทรนด์ภาพระดับหลายเดือนยังมีฐานราคาที่ยกตัวสูงกว่าช่วงครึ่งปีแรกอย่างเด่นชัด" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 13.16 },
        "poc": { "label": "POC", "price": 12.00 },
        "resistances": [{ "label": "R1", "price": 14.50 }, { "label": "R2", "price": 16.00 }],
        "supports": [{ "label": "S1", "price": 12.50 }, { "label": "S2", "price": 12.00 }],
        "vah": { "label": "VAH", "price": 13.50 },
        "val": { "label": "VAL", "price": 11.50 }
      },
      "entry": {
        "signal": "BUY",
      ...
      "confluences": [
        { "name": "แรงรับซื้อคืนหนาแน่นเหนือแนวรับสำคัญที่ $12.50", "confirmed": True },
        { "name": "การเด้งตัวจากระนาบ Oversold อย่างเฉียบพลันเกิดสัญญาณดีดตัวขึ้น", "confirmed": True },
        { "name": "เกิดสัญญาณ Bullish Divergence อ่อนๆ ในช่วงกราฟระยะรายวัน", "confirmed": True }
      ],
      "risk": {
        "positionSize": "5%",
        "riskPct": "15.0%",
    ...
    "fundamental": {
      "incomeStatement": [
        { "metric": "Revenue", "value": ">$5.0B", "grade": "A" },
        { "metric": "Net Income Growth", "value": "+41.0%", "grade": "A" }
      ],
      "balanceSheet": [
        { "metric": "Capital Ratio", "value": "Strong", "grade": "A" },
        { "metric": "ROE", "value": "29.0%", "grade": "A" }
      ],
      "cashflow": [
        { "metric": "Deposits Growth", "value": "High", "grade": "A" }
      ],
      "valuation": [
        { "metric": "P/E Ratio", "value": "25.0x", "grade": "B" },
        { "metric": "PEG Ratio", "value": "0.8", "grade": "A" }
      ],
      "overallGrade": "A",
      "gradeBreakdown": [
        { "label": "Growth", "score": 92, "color": "var(--grade-a)" },
        { "label": "Profitability", "score": 90, "color": "var(--grade-a)" },
        { "label": "Asset quality", "score": 88, "color": "var(--grade-a)" }
      ],
      "moat": {
        "overall": "Wide",
        "items": [
          { "icon": "🏦", "name": "Digital Banking Monopolistic Leader", "strength": 90, "description": "การครองฐานลูกค้ารวมกว่า 135 ล้านรายในแถบละตินอเมริกา (บราซิล เม็กซิโก และโคลอมเบีย) ด้วยระบบดิจิทัลแบบร้อยเปอร์เซ็นต์และต้นทุนดำเนินงานที่ถูกกว่าธนาคารแบบเดิมอย่างมหาศาล" }
        ]
      }
    },
    "thesis": {
      ...
      "sources": ["Nubank Q1 2026 Earnings Release", "LatAm Fintech Market Reports"]
    }
  },
  "MELI": {
    "meta": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Strong",
        "timeframes": [
          { "tf": "Daily", "bias": "bullish", "note": "ราคายืนเหนือ EMA 20 และ EMA 50 วันได้อย่างมั่นคง" },
          { "tf": "Weekly", "bias": "bullish", "note": "กรอบทิศทางระยะยาวรักษาฐานขาขึ้นอย่างเด่นชัด" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 1677.90 },
        "poc": { "label": "POC", "price": 1600.00 },
        "resistances": [{ "label": "R1", "price": 1720.00 }, { "label": "R2", "price": 1800.00 }],
        "supports": [{ "label": "S1", "price": 1620.00 }, { "label": "S2", "price": 1550.00 }],
        "vah": { "label": "VAH", "price": 1700.00 },
        "val": { "label": "VAL", "price": 1500.00 }
      },
      "entry": {
        "signal": "BUY",
      ...
      "confluences": [
        { "name": "ยืนเหนือแนวรับเส้น EMA 50 วัน", "confirmed": True },
        { "name": "แรงซื้อกลับอย่างหนาแน่นแถวระนาบจิตวิทยา $1,600", "confirmed": True },
        { "name": "RSI ในระดับ 58 บ่งบอกโมเมนตัมยังมีแรงส่งต่อ", "confirmed": True }
      ],
      "risk": {
        "positionSize": "4%",
        "riskPct": "6.0%",
    ...
    "fundamental": {
      "incomeStatement": [
        { "metric": "Revenue Growth", "value": "+36.0%", "grade": "A" },
        { "metric": "Operating Margin", "value": "15.4%", "grade": "B" }
      ],
      "balanceSheet": [
        { "metric": "Debt/Equity", "value": "0.35", "grade": "B" },
        { "metric": "ROE", "value": "32.0%", "grade": "A" }
      ],
      "cashflow": [
        { "metric": "Free Cash Flow", "value": "Strong Growth", "grade": "A" }
      ],
      "valuation": [
        { "metric": "P/E Ratio", "value": "38.0x", "grade": "C" },
        { "metric": "PEG Ratio", "value": "1.1", "grade": "A" }
      ],
      "overallGrade": "A",
      "gradeBreakdown": [
        { "label": "Growth", "score": 95, "color": "var(--grade-a)" },
        { "label": "Profitability", "score": 85, "color": "var(--grade-b)" },
        { "label": "Financial Health", "score": 90, "color": "var(--grade-a)" }
      ],
      "moat": {
        "overall": "Wide",
        "items": [
          { "icon": "🌐", "name": "MercadoPago Ecosystem Network Effect", "strength": 92, "description": "การครองฐานลูกค้ารวมกว่า 140 ล้านคนในแถบละตินอเมริกาและระบบชำระเงินดิจิทัลที่มีเครือข่ายร้านค้าและผู้ใช้งานผูกขาดอย่างเหนียวแน่น" }
        ]
      }
    },
    "thesis": {
      ...
      "sources": ["MercadoLibre Q1 2026 Earnings Report", "LatAm Digital Commerce Monitor"]
    }
  },
  "AVGO": {
    "meta": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Neutral",
        "timeframes": [
          { "tf": "Daily", "bias": "neutral", "note": "ปรับฐานย่อตัวระยะสั้นลงมาทดสอบแนวรับเส้นค่าเฉลี่ย EMA 50 วัน" },
          { "tf": "Weekly", "bias": "bullish", "note": "กรอบทิศทางภาพใหญ่ระยะกลางยังเป็นทิศทางขาขึ้นอย่างสมบูรณ์" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 414.57 },
        "poc": { "label": "POC", "price": 400.00 },
        "resistances": [{ "label": "R1", "price": 440.00 }, { "label": "R2", "price": 465.00 }],
        "supports": [{ "label": "S1", "price": 405.00 }, { "label": "S2", "price": 385.00 }],
        "vah": { "label": "VAH", "price": 435.00 },
        "val": { "label": "VAL", "price": 380.00 }
      },
      "entry": {
        "signal": "BUY",
        "entryZone": "$400 – $415",
      ...
      "confluences": [
        { "name": "การประคองตัวยืนยันความแข็งแกร่งบริเวณเส้นเฉลี่ย EMA 50 วัน", "confirmed": True },
        { "name": "แนวรับปริมาณหนาแน่นจาก Volume Profile POC ที่ $400", "confirmed": True },
        { "name": "ดัชนี RSI ผ่อนคลายความร้อนแรงลงมาแตะเขตกลาง 45-50", "confirmed": True }
      ],
      "risk": {
        "positionSize": "4%",
        "riskPct": "7.2%",
    ...
    "fundamental": {
      "incomeStatement": [
        { "metric": "Revenue Growth", "value": "+24.0%", "grade": "A" },
        { "metric": "Operating Margin", "value": "46.2%", "grade": "A" }
      ],
      "balanceSheet": [
        { "metric": "Debt/Equity", "value": "0.85", "grade": "B" },
        { "metric": "ROE", "value": "26.5%", "grade": "A" }
      ],
      "cashflow": [
        { "metric": "FCF Margin", "value": "45.0%", "grade": "A" }
      ],
      "valuation": [
        { "metric": "P/E Ratio", "value": "29.0x", "grade": "B" },
        { "metric": "PEG Ratio", "value": "1.2", "grade": "A" }
      ],
      "overallGrade": "A",
      "gradeBreakdown": [
        { "label": "Profitability", "score": 96, "color": "var(--grade-a)" },
        { "label": "Growth", "score": 88, "color": "var(--grade-a)" },
        { "label": "Financial Health", "score": 85, "color": "var(--grade-b)" }
      ],
      "moat": {
        "overall": "Wide",
        "items": [
          { "icon": "🛰️", "name": "AI Networking Patents Monopoly", "strength": 96, "description": "การผูกขาดในส่วนประกอบชิปการเชื่อมต่อสื่อสารข้อมูลสำหรับ AI คลัสเตอร์ รวมทั้งลิขสิทธิ์ซอฟต์แวร์ระบบคลาวด์จาก VMware" }
        ]
      }
    },
    "thesis": {
      ...
      "sources": ["Broadcom Q1 Fiscal 2026 Earnings", "AI Hardware Connectivity Survey"]
    }
  },
  "ASML": {
    "meta": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Strong",
        "timeframes": [
          { "tf": "Daily", "bias": "bullish", "note": "ราคากลับตัวทะลุต้านแนวเฉลี่ยระยะสั้น EMA 20 และ EMA 50 วันขึ้นมาอย่างเด็ดขาด" },
          { "tf": "Weekly", "bias": "bullish", "note": "เกิดการดีดกลับหลังจากแตะแนวรับจิตวิทยาเส้นล่างสุดของรอบปี" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 1592.00 },
        "poc": { "label": "POC", "price": 1500.00 },
        "resistances": [{ "label": "R1", "price": 1640.00 }, { "label": "R2", "price": 1750.00 }],
        "supports": [{ "label": "S1", "price": 1530.00 }, { "label": "S2", "price": 1450.00 }],
        "vah": { "label": "VAH", "price": 1680.00 },
        "val": { "label": "VAL", "price": 1400.00 }
      },
      "entry": {
        "signal": "BUY",
      ...
      "confluences": [
        { "name": "รูปแบบการกลับตัว Double Bottom แถวระนาบราคา $1,450", "confirmed": True },
        { "name": "เกิดสัญญาณ Bullish Divergence ในดัชนี RSI ระยะรายวัน", "confirmed": True },
        { "name": "ราคาผ่านการเบรคเอาท์ต้านแนวระนาบราคาเส้น EMA 50 วัน", "confirmed": True }
      ],
      "risk": {
        "positionSize": "4%",
        "riskPct": "8.8%",
    ...
    "fundamental": {
      "incomeStatement": [
        { "metric": "Revenue Growth", "value": "+18.0%", "grade": "B" },
        { "metric": "Gross Margin", "value": "51.3%", "grade": "A" }
      ],
      "balanceSheet": [
        { "metric": "Debt/Equity", "value": "0.15", "grade": "A" },
        { "metric": "ROE", "value": "29.5%", "grade": "A" }
      ],
      "cashflow": [
        { "metric": "FCF Conversion", "value": "Excellent", "grade": "A" }
      ],
      "valuation": [
        { "metric": "P/E Ratio", "value": "34.0x", "grade": "B" },
        { "metric": "PEG Ratio", "value": "1.3", "grade": "A" }
      ],
      "overallGrade": "A+",
      "gradeBreakdown": [
        { "label": "Moat Strength", "score": 100, "color": "var(--grade-a)" },
        { "label": "Financial Health", "score": 96, "color": "var(--grade-a)" },
        { "label": "Profitability", "score": 94, "color": "var(--grade-a)" }
      ],
      "moat": {
        "overall": "Wide",
        "items": [
          { "icon": "🔬", "name": "EUV Photolithography Monopoly", "strength": 99, "description": "การผูกขาดหนึ่งเดียวของโลกในเทคโนโลยีการพิมพ์ชิป EUV/High-NA EUV ซึ่งประเมินค่าไม่ได้สำหรับอุตสาหกรรมชิประดับโลก" }
        ]
      }
    },
    "thesis": {
      ...
      "sources": ["ASML Q1 2026 Annual Report", "ASML Investor Day Presentation"]
    }
  },
  "ANET": {
    "meta": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Strong",
        "timeframes": [
          { "tf": "Daily", "bias": "bullish", "note": "ประคองตัวบนแนวโน้มขาขึ้นอย่างสวยงามตามกลุ่มนำตลาด AI" },
          { "tf": "Weekly", "bias": "bullish", "note": "เทรนด์ระยะยาวมีพลังสูง ยืนเหนือเส้นเฉลี่ย EMA 20 ได้อย่างสม่ำเสมอ" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 153.82 },
        "poc": { "label": "POC", "price": 142.00 },
        "resistances": [{ "label": "R1", "price": 165.00 }, { "label": "R2", "price": 180.00 }],
        "supports": [{ "label": "S1", "price": 148.00 }, { "label": "S2", "price": 142.00 }],
        "vah": { "label": "VAH", "price": 158.00 },
        "val": { "label": "VAL", "price": 138.00 }
      },
      "entry": {
        "signal": "BUY",
        "entryZone": "$145 – $152",
      ...
      "confluences": [
        { "name": "แรงพยุงจากเส้นค่าเฉลี่ย EMA 50 วัน และ Volume Profile POC บริเวณ $142", "confirmed": True },
        { "name": "RSI ระดับ 58 ชี้ว่าระดับราคายังมีเพดานวิ่งต่อได้สูงโดยไม่อิ่มตัว", "confirmed": True },
        { "name": "ความได้เปรียบทางโมเมนตัมเครือข่าย AI ที่มีความต้องการสูงมาก", "confirmed": True }
      ],
      "risk": {
        "positionSize": "4%",
        "riskPct": "7.8%",
    ...
    "fundamental": {
      "incomeStatement": [
        { "metric": "Revenue Growth", "value": "+35.1%", "grade": "A" },
        { "metric": "Gross Margin", "value": "64.2%", "grade": "A" }
      ],
      "balanceSheet": [
        { "metric": "Debt/Equity", "value": "0.02", "grade": "A" },
        { "metric": "ROE", "value": "31.5%", "grade": "A" }
      ],
      "cashflow": [
        { "metric": "Free Cash Flow", "value": "Strong", "grade": "A" }
      ],
      "valuation": [
        { "metric": "P/E Ratio", "value": "52.5x", "grade": "C" },
        { "metric": "PEG Ratio", "value": "1.1", "grade": "A" }
      ],
      "overallGrade": "A",
      "gradeBreakdown": [
      ...
      "moat": {
        "overall": "Wide",
        "items": [
          { "icon": "🔌", "name": "AI Fabric & Cloud Networking Dominance", "strength": 92, "description": "การครองความเป็นผู้นำร่วมในส่วนแบ่งตลาด Cloud Switches ระดับความเร็วสูงด้วยความเสถียรของซอฟต์แวร์ EOS" }
        ]
      }
    },
    "thesis": {
      ...
      "sources": ["ANET Q1 2026 Earnings Transcript", "Ethernet Consortium Technical Papers"]
    }
  },
  "PLTR": {
    "meta": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Neutral",
        "timeframes": [
          { "tf": "Daily", "bias": "neutral", "note": "ย่อตัวพักฐานสะสมกำลังหลังแตะจุดสูงสุดบริเวณ $145" },
          { "tf": "Weekly", "bias": "bullish", "note": "แนวโน้มระยะยาวมั่นคงและแข็งแกร่งมากตามฐานรายได้ระบบ AIP" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 136.56 },
        "poc": { "label": "POC", "price": 128.00 },
        "resistances": [{ "label": "R1", "price": 145.00 }, { "label": "R2", "price": 160.00 }],
        "supports": [{ "label": "S1", "price": 130.00 }, { "label": "S2", "price": 122.00 }],
        "vah": { "label": "VAH", "price": 140.00 },
        "val": { "label": "VAL", "price": 120.00 }
      },
      "entry": {
        "signal": "BUY",
        "entryZone": "$128 – $135",
      ...
      "confluences": [
        { "name": "แนวพยุงสำคัญที่ทับซ้อนกันระหว่างระดับราคา VAH ล่างสุดกับเส้น EMA 50 วัน", "confirmed": True },
        { "name": "โมเมนตัม RSI ลดความตึงเครียดกลับมาอยู่ที่ 52 ซึ่งเหมาะสมกับการสะสม", "confirmed": True },
        { "name": "อุปสงค์ความต้องการแพลตฟอร์ม AI ในสหรัฐฯ ขยายตัวก้าวกระโดด", "confirmed": True }
      ],
      "risk": {
        "positionSize": "5%",
        "riskPct": "12.0%",
    ...
    "fundamental": {
      "incomeStatement": [
        { "metric": "Revenue Growth", "value": "+85.0%", "grade": "A" },
        { "metric": "Operating Margin", "value": "38.5%", "grade": "A" }
      ],
      "balanceSheet": [
        { "metric": "Debt/Equity", "value": "0.05", "grade": "A" },
        { "metric": "ROE", "value": "35.2%", "grade": "A" }
      ],
      "cashflow": [
        { "metric": "Free Cash Flow", "value": "Exceptional", "grade": "A" }
      ],
      "valuation": [
        { "metric": "P/E Ratio", "value": "78.0x", "grade": "D" },
        { "metric": "PEG Ratio", "value": "0.51", "grade": "A" }
      ],
      "overallGrade": "A",
      "gradeBreakdown": [
        { "label": "Growth", "score": 98, "color": "var(--grade-a)" },
        { "label": "Financial Health", "score": 96, "color": "var(--grade-a)" },
        { "label": "Profitability", "score": 92, "color": "var(--grade-a)" }
      ],
      "moat": {
        "overall": "Wide",
        "items": [
          { "icon": "🛰️", "name": "Ontology & AI Operating System", "strength": 96, "description": "การผูกขาดแพลตฟอร์มจัดการข้อมูลระดับความมั่นคงและ AIP ที่ช่วยเปลี่ยนผ่านสู่ AI แบบเบ็ดเสร็จในองค์กร" }
        ]
      }
    },
    "thesis": {
      ...
      "sources": ["PLTR Q1 2026 Financial Results", "Palantir AIP Bootcamp Statistics"]
    }
  },
  "ATAT": {
    "meta": {
    ...
    "technical": {
      ...
      "trend": {
        ...
        "strength": "Strong",
        "timeframes": [
          { "tf": "Daily", "bias": "bullish", "note": "ราคากลับตัวฟื้นจากแนวรับจิตวิทยา $32 ทะลุเส้น EMA 20 อย่างมั่นใจ" },
          { "tf": "Weekly", "bias": "bullish", "note": "แนวโน้มระยะกลางถึงยาวยังสะท้อนภาพการเติบโตแบบยกโลว์ยกระดับฐานราคา" }
        ]
      },
      "levels": {
        "current": { "label": "Current", "price": 35.79 },
        "poc": { "label": "POC", "price": 32.00 },
        "resistances": [{ "label": "R1", "price": 38.00 }, { "label": "R2", "price": 42.00 }],
        "supports": [{ "label": "S1", "price": 33.00 }, { "label": "S2", "price": 31.00 }],
        "vah": { "label": "VAH", "price": 37.00 },
        "val": { "label": "VAL", "price": 30.00 }
      },
      "entry": {
        "signal": "BUY",
      ...
      "confluences": [
        { "name": "รูปแบบการกลับตัวจากฐานบริเวณ POC แข็งแกร่งที่ $32", "confirmed": True },
        { "name": "การฟื้นตัวของดัชนีชี้วัดโมเมนตัม MACD ตัดขึ้นในระดับรายวัน", "confirmed": True },
        { "name": "ความเชื่อมั่นในผลประกอบการท่องเที่ยวที่เติบโตต่อเนื่องในเอเชีย", "confirmed": True }
      ],
      "risk": {
        "positionSize": "3%",
        "riskPct": "10.0%",
    ...
    "fundamental": {
      "incomeStatement": [
        { "metric": "Revenue Growth", "value": "+47.5%", "grade": "A" },
        { "metric": "Gross Margin", "value": "45.0%", "grade": "B" }
      ],
      "balanceSheet": [
        { "metric": "Debt/Equity", "value": "0.18", "grade": "A" },
        { "metric": "ROE", "value": "51.2%", "grade": "A" }
      ],
      "cashflow": [
        { "metric": "Free Cash Flow", "value": "Excellent", "grade": "A" }
      ],
      "valuation": [
        { "metric": "P/E Ratio", "value": "18.5x", "grade": "A" },
        { "metric": "PEG Ratio", "value": "0.26", "grade": "A" }
      ],
      "overallGrade": "A+",
      "gradeBreakdown": [
        { "label": "Growth", "score": 96, "color": "var(--grade-a)" },
        { "label": "Financial Health", "score": 94, "color": "var(--grade-a)" },
        { "label": "Profitability", "score": 99, "color": "var(--grade-a)" }
      ],
      "moat": {
        "overall": "Narrow",
        "items": [
          { "icon": "👑", "name": "Lifestyle Hospitality Brand Power", "strength": 85, "description": "การเป็นเจ้าตลาดกลุ่มท่องเที่ยวโรงแรมพรีเมียมพร้อมการต่อยอดขายสินค้าเครื่องนอนไลฟ์สไตล์ที่มีสัดส่วนกำไรสูง" }
        ]
      }
    },
    "thesis": {
      ...
      "sources": ["ATAT Q1 2026 Operational Results", "Lifestyle Retail Growth Report"]
    }
  }
}
...
const stocksData = {stocks_data_json};

let activeStock = "{active_stock}";
document.addEventListener('DOMContentLoaded', () => {{
  const selector = document.getElementById('stock-selector');
  if(selector) {{
    selector.innerHTML = `{selector_options}`;
...
def generate_js_content(title, stocks_list, active_stock, stocks_data_dict, selector_options):
    stocks_data_json = json.dumps(stocks_data_dict, indent=2, ensure_ascii=False)
    # Re-inject double braces for JavaScript strings correctly
    content = js_template.format(
        title=title,
        stocks=stocks_list,
        stocks_data_json=stocks_data_json,
        active_stock=active_stock,
        selector_options=selector_options
    )
    return content

def fetch_live_price(symbol, fallback_price, fallback_change, fallback_pct):
    ...
    try:
        with urllib.request.urlopen(req, timeout=5) as response:
            ...
            return current_price, change, pct, today
    except Exception as e:
        print(f"Warning: Failed to fetch live price for {symbol} ({e}). Using fallback.")
        return fallback_price, fallback_change, fallback_pct, "2026-05-28"

# Automatically update prices and changes with live data from Yahoo Finance
print("Fetching latest stock prices from Yahoo Finance...")
for sym in portfolio_data.keys():
    meta = portfolio_data[sym]["meta"]
    p, c, pct, date = fetch_live_price(sym, meta["currentPrice"], meta["priceChange"], meta["priceChangePct"])
    meta["currentPrice"] = p
    meta["priceChange"] = c
    meta["priceChangePct"] = pct
    meta["analysisDate"] = date

for sym in growth_data.keys():
    meta = growth_data[sym]["meta"]
    p, c, pct, date = fetch_live_price(sym, meta["currentPrice"], meta["priceChange"], meta["priceChangePct"])
    meta["currentPrice"] = p
    meta["priceChange"] = c
    meta["priceChangePct"] = pct
...
def make_selector(stocks_list, data_dict):
    options = []
    for s in stocks_list:
        company = data_dict[s]['meta'].get('companyName', s)
        if company.endswith('.'):
            company = company[:-1]
        options.append(f'\\n      <option value="{s}">{company} ({s})</option>')
    return "".join(options) + "\\n    "
...
growth_list = ["META", "LLY", "VRT", "NU", "MELI", "AVGO", "ASML", "ANET", "PLTR", "ATAT"]
...
unified_list = ["GOOGL", "MU", "TSM", "NVDA", "META", "LLY", "VRT", "NU", "MELI", "AVGO", "ASML", "ANET", "PLTR", "ATAT"]
